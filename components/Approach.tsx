...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  lg:max-w-sm md:max-w-lg sm:max-w-md w-[80vw] h-[18rem] mx-auto p-4 relative lg:h-[35rem] md:h-[18rem]"
      style={{
